        ...
        <View style={this.state.light_theme?styles.appContainerLight:styles.appContainer}>
          ...
          <View style={this.state.light_theme?styles.containerLight:styles.container}>
            ...
            <Text style={{
              ...
              From: 
              <Text style={{color:this.state.light_theme? '#e0ffff':'#000000'}}>
            ...
            <Text style={{
                ...
                Updated on: 
                <Text  style={{color:this.state.light_theme? 'white':'black',margin:RFValue(1)}}>
            ...
            <TouchableOpacity onPress={()=>this.props.navigation.navigate("ChatRoom",{chat: this.props.route.params.details})}>
              ...
              <Text style={{alignSelf:'center',color:this.state.light_theme? 'white':'black'}}>
                Message
              </Text>
